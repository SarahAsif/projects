...
import FootballBG from "../images/footballbg.png";
    ...
    <div className=" text-zinc-800 mt-40">
      <div className="py-7 px-40 grid grid-flow-row max-w-4xl">
        <div>
          ...
          <div className="mb-4">
            <p>
              Join a network of players near you to make you no longer cancel a
              game for last minutes dropouts
            </p>
          </div>
        </div>
      </div>
      <div className="px-40">
        <Button variant="contained" endIcon={<TrendingFlat />} color="warning">
          Start Demo
        </Button>
      </div>
      <div>
      ...
      <img src={FootballBG} className="absolute right-0 top-20" />
      <img src={Football} className="absolute right-0 top-0 w-2/8" />
